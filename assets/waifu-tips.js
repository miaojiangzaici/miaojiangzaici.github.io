window.live2d_settings = Array(); /*
    ...
    く__,.ヘヽ.　　　　/　,ー､ 〉
    　　　　　＼ ', !-─‐-i　/　/´
    　　　 　 ／｀ｰ'　　　 L/／｀ヽ､            彩蛋：Live2D 看板娘 参数设置
    　　 　 /　 ／,　 /|　 ,　 ,　　　 ',                                           Version 1.4.2
    　　　ｲ 　/ /-‐/　ｉ　L_ ﾊ ヽ!　 i                            Update 2020/3/16
    　　　 ﾚ ﾍ 7ｲ｀ﾄ　 ﾚ'ｧ-ﾄ､!ハ|　 |  
    　　　　 !,/7 '0'　　 ´0iソ| 　 |　　　
    　　　　 |.从"　　_　　 ,,,, / |./ 　 |             网页添加 Live2D 看板娘
...
// 默认模型
live2d_settings['modelId']              = 105;            // 默认模型 ID，可在 F12 控制台找到
...
live2d_settings['l2dVerDate']           = '2020.3.16'; // 版本更新日期
live2d_settings['homePageUrl']          = 'auto';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://miaooao.top/about';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= 'miaoOAO.png'; // 看板娘截图文件名，例如 'live2d.png'
